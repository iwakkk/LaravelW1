    ...
    <div class="container justify-content-center justify-content-md-between">
      ...
      <div class="collapse navbar-collapse" id="navbarLeftAlignExample">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link text-dark" href="<?php echo e(url('/contact')); ?>">Contact Us</a>
          </li>
        </ul>
        <!-- Left links -->
      </div>
...
<?php /**PATH C:\xampp\htdocs\commerceW1\resources\views/template/header.blade.php ENDPATH**/ ?>